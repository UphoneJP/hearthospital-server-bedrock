...
app.use('/api/user', originalSecurity, checkIntegrity, apiUserRoutes)
app.use('/api/hospital', originalSecurity, checkIntegrity, apiHospitalRoutes)
app.use('/api/talkingRoom', originalSecurity, checkIntegrity, apiTalkingRoomRoutes)
app.use('/api/others', originalSecurity, checkIntegrity, apiOtherRoutes)
